...
const becomeModeratorFeatures = () => {
  return (
      ...
      <ScrollView style={tw`flex bg-[#ffffff] flex-col h-full `}> 
          ...
          <Image style={tw`h-full w-full`} source={require('./../../../assets/Moderator/feature1.png')} style={{ width: 180, height: 150,backgroundColor:'#fff',alignSelf: "center" }} />          
          <Text style={tw`ml-2 text-sm font-medium text-center text-[#000000] flex-1`}>You are the pillars holding up our community.</Text>
           
          <Image style={tw`h-full w-full`} source={require('./../../../assets/Moderator/feature2.png')} style={{backgroundColor:'#fff',alignSelf: "center" }}/>          
          ...
          <Image style={tw`h-full w-full`} source={require('./../../../assets/Moderator/feature3.png')}style={{width: 180,height: 150,backgroundColor:'#fff',alignSelf: "center" }} />          
          <Text style={tw`ml-2 text-sm font-medium text-center text-[#000000] flex-1`}>Join with us and help improve our application with your valuable contribution.</Text>     
      </ScrollView>
