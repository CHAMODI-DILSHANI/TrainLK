...
const howtobecomeModerator = () => {
  return (
      <View style={tw`flex flex-row pl-6 pr-6 py-10 bg-[#ffffff]`}>
      <ScrollView style={tw`flex bg-[#ffffff] flex-col h-full `}> 
       
          <CardImage source={require('./../../../assets/Moderator/howtobecome1.png')} style={{ width: 180, height: 150,backgroundColor:'#fff',alignSelf: "center" }} />          
          ...
          <CardImage source={require('./../../../assets/Moderator/howtobecome2.png')} style={{width: 180,height: 150, backgroundColor:'#fff',alignSelf: "center" }}/>          
          ...
          <CardImage source={require('./../../../assets/Moderator/howtobecome3.png')}style={{width: 180,height: 150,backgroundColor:'#fff',alignSelf: "center" }} />          
